...
THREE.STLLoader.prototype.parseBinary = function (data) {
    ...
    position: {
      itemSize: 3,
      array: new Float32Array( n_faces * 3 * 3 )
    },
    normal: {
      itemSize: 3,
      array: new Float32Array( n_faces * 3 * 3 )
  ...
  var i2 = 0, i9 = 0;
    ...
    normals[ i9 + 8 ] = nz;
		...
		for (i = 1; i <= 3; i++) {
			...
			var px = reader.getFloat32(vertexstart,true);
			var py = reader.getFloat32(vertexstart +4,true);
			var pz = reader.getFloat32(vertexstart + 8,true);
			var i3 = (i-1)*3;
      positions[ i9 + i3 + 0 ] = px;
      positions[ i9 + i3 + 1 ] = py;
      positions[ i9 + i3 + 2 ] = pz;
